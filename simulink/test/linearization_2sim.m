% This script sets parameters for linearization, runs a simulation one time to
% get a steady-state operating point, and then uses this point as initial condition
% for a second simulation that also performs a linearization. Linearization
% is simulated and the output is compared against the nonlinear system
%% Clear environment
clearvars;clc
...
FAST_InputFileName = newFSTName; %#ok<NASGU>
...
% Linearization
FP_mod = SetFASTPar(FP,'Linearize','True'); % Linearization turned on
