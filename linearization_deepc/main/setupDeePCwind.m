...
if previewFlag == 1    
    dataWind.Wp = constructHankelMat(dataWind.u_windSpeed,i,p,Nbar); % past data
    dataWind.Wf = constructHankelMat(dataWind.u_windSpeed,i+p,f,Nbar); % future data
else
    dataWind.Wp = [];
    dataWind.Wf = [];
end
...
if previewFlag == 1
    dataWind.wini = constructHankelMat(dataWind.u_windSpeed,i+N-p,p,1);
else
    dataWind.wini = [];
end
